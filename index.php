...
<head>
    <script src="https://www.google.com/recaptcha/enterprise.js?render=6Lf_2DopAAAAACH5jhKguQykXjFcthPUJ7T91tUv"></script>
    <meta charset="UTF-8">
...
<body>
    ...
    <script>
        function onClick(e) {
            ...
            grecaptcha.enterprise.ready(async () => {
                const token = await grecaptcha.enterprise.execute('6Lf_2DopAAAAACH5jhKguQykXjFcthPUJ7T91tUv', {
                    action: 'LOGIN'
                });
            });
        }
        ...
        <div class="auth_container">
            ...
            <div id="Log_in">
                ...
                <form class="user_login authsection active" id="userlogin" action="" method="POST">
                    ...
                    <div class="footer_line">
                        <a href="reset_password_ver.php" class="forgot-password">Forgot Password?</a>
                    </div>
                </form>
    ...
    <ul>
        <li id="criteria-length">Minimum 8 characters</li>
        <li id="criteria-uppercase">Uppercase letter(s)</li>
        <li id="criteria-lowercase">Lowercase letter(s)</li>
        <li id="criteria-number">Number(s)</li>
        <li id="criteria-special">Special character(s) (!, @, #, etc.)</li>
    </ul>
</div>
                </form>
            </div>
...
<script>
    document.getElementById('password').addEventListener('input', function() {
        ...
        // Example criteria: Check length, include numbers, uppercase letters, symbols, etc.

        // Calculate the strength (this is a simplified example)
        ...
        // Determine strength text based on the calculated strength
