  ...
  <section id="firstsection" class="carousel slide carousel_section" data-bs-ride="carousel">
    <div class="carousel-inner">
        ...
        <div class="welcomeline">
          <h1 class="welcometag">Never Lost, Johor Bahru Awaits</h1>
        </div>
      ...
      <div class="roomselect">
        <div class="roombox">
          ...
          <div class="roomdata">
            ...
            <button class="btn btn-primary bookbtn" onclick="window.location.href = 'homediscstudents.php'">Click Here!</button>         
           </div>
        </div>
        <div class="roombox">
          ...
          <div class="roomdata">
            ...
            <button class="btn btn-primary bookbtn" onclick="window.location.href = 'homedisctourists.php'">Click Here!</button>          
          </div>
        </div>
        <div class="roombox">
          ...
          <div class="roomdata">
            ...
            <button class="btn btn-primary bookbtn" onclick="window.location.href = 'homefindhc.php'">Click Here!</button>         
           </div>
        </div>
        <div class="roombox">
          ...
          <div class="roomdata">
            ...
            <button class="btn btn-primary bookbtn" onclick="window.location.href = 'homeextrafeatures.php'">Click Here!</button>
                    </div>
        </div>
      </div>
    </div>
