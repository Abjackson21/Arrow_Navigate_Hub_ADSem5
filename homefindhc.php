...
<div class="logo" onclick="window.location.href='home.php'" style="cursor: pointer;">
  ...
  <section id="secondsection"> 
    ...
    <div class="ourroom">
      <h1 class="head"> Health Centers </h1>
      <div class="roomselect">
        <div class="roombox">
          <div class="hotelphoto h1"></div>
          <div class="roomdata">
            <h2>Utm Clinic</h2>
            <button class="btn btn-primary bookbtn" onclick="window.location.href='https://maps.app.goo.gl/TnV5pzapc5Tc9xsv6'" type="button">Click Here!</button>
                    </div>
        </div>
        <div class="roombox">
          ...
          <div class="roomdata">
            ...
            <button class="btn btn-primary bookbtn" onclick="window.location.href='https://www.pacificinsurance.com.my/products/medical/'" type="button">Click Here!</button>
                    </div>
        </div>
        <div class="roombox">
          ...
          <div class="roomdata">
            <h2>Hospitals</h2>
            <a class="btn btn-primary bookbtn" href="SERVICES/findneareshealthc.html">Click Here!</a>
          </div>
        </div>
        <div class="roombox">
          <div class="hotelphoto h4"></div>
          <div class="roomdata">
            <h2>Utm Clinic Reservations</h2>
            <a class="btn btn-primary bookbtn" href="reservation_form.php">Click Here!</a>
          </div>
        </div>
  </section>
